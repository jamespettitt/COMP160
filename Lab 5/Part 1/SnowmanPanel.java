...
public class SnowmanPanel extends JPanel{
  ...
  public void paintComponent (Graphics page)
  {
    ...
    page.drawArc (MID - 10, TOP + 20, 20, 10, 370, 160);   // smile
    ...
    page.setColor( Color.red );                     //top button
    page.fillOval(MID - 3, TOP + 45, 7, 7);
    
    page.setColor( Color.red );                      //bottom button
    page.fillOval(MID - 3, TOP + 60, 7, 7);
  
    page.drawString( "James", 45, 20);              //text
  }
}
